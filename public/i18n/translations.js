...
const translations = {
  ...
  zh: {
    ...
    'svc.p0.tag':      'Public Institution',
    'svc.p0.name':     '政府机关',
    'svc.p0.desc':     '以广播制作、数字媒体、档案管理及无障碍广播系统的丰富经验，为政府机关提供最优化的解决方案。构建媒体存储、视频服务器及媒体管理系统，为内容制作提供稳定基础。',
    'svc.p0.c1': '广播SI', 'svc.p0.c2': '档案系统', 'svc.p0.c3': '无障碍广播', 'svc.p0.c4': 'MAM资产管理', 'svc.p0.c5': '视频会议',
    'svc.p1.tag':      'Education',
    'svc.p1.name':     '教育机构',
    'svc.p1.desc':     '从网络大学到中小学，为各类教育机构设计最优学习环境。通过e-learning演播室、智慧教室和LED显示屏，实现线上线下全覆盖教学。',
    'svc.p1.c1': 'e-Learning演播室', 'svc.p1.c2': '智慧教室', 'svc.p1.c3': '混合式教学', 'svc.p1.c4': '交互式显示', 'svc.p1.c5': 'LED显示屏',
    'svc.p2.tag':      'Enterprise',
    'svc.p2.name':     '企业',
    'svc.p2.desc':     '支持企业YouTube频道、内部广播及视频会议系统等各类企业媒体环境。与Zoom、Teams、Webex等主流平台完美兼容，打造智慧办公环境。',
    'svc.p2.c1': 'YouTube演播室', 'svc.p2.c2': '视频会议', 'svc.p2.c3': '内部广播', 'svc.p2.c4': 'Zoom Teams集成', 'svc.p2.c5': '智慧办公',
    'svc.p3.tag':      'Media Center',
    'svc.p3.name':     '媒体中心',
    'svc.p3.desc':     '从P1.5超高分辨率LED Wall和大型户外广告牌到XR虚拟演播室，为专业媒体中心提供全套解决方案。',
    'svc.p3.c1': 'LED Wall', 'svc.p3.c2': 'XR虚拟演播室', 'svc.p3.c3': '媒体服务器', 'svc.p3.c4': '大型广告牌', 'svc.p3.c5': '媒体档案',
    'svc.p4.tag':      'Religious Facility',
    'svc.p4.name':     '宗教设施',
    'svc.p4.desc':     '为教堂、大教堂及寺庙等宗教场所构建音视频及灯光一体化系统。礼拜视频播出、LED显示屏及在线直播，提供专为宗教空间优化的解决方案。',
    'svc.p4.c1': '音视频集成', 'svc.p4.c2': '礼拜视频播出', 'svc.p4.c3': '在线直播', 'svc.p4.c4': 'LED广告牌', 'svc.p4.c5': '灯光系统',
  ...
  ja: {
    ...
    'svc.p0.tag':      'Public Institution',
    'svc.p0.name':     '公共機関',
    'svc.p0.desc':     '放送制作、デジタルメディア、アーカイブ、バリアフリー放送システムの豊富な経験を活かし、公共機関に最適化されたソリューションを提供します。安定したコンテンツ制作基盤のためのメディアストレージ・ビデオサーバー・MAMシステムを構築します。',
    'svc.p0.c1': '放送SI', 'svc.p0.c2': 'アーカイブシステム', 'svc.p0.c3': 'バリアフリー放送', 'svc.p0.c4': 'MAM資産管理', 'svc.p0.c5': 'ビデオ会議',
    'svc.p1.tag':      'Education',
    'svc.p1.name':     '教育機関',
    'svc.p1.desc':     'サイバー大学から小中高まで、目的に合わせた最適な学習環境を設計します。eラーニングスタジオ・スマート教室・LEDディスプレイでオンライン・オフライン両方の教育に対応します。',
    'svc.p1.c1': 'eラーニングスタジオ', 'svc.p1.c2': 'スマート教室', 'svc.p1.c3': 'ハイブリッド授業', 'svc.p1.c4': 'インタラクティブ表示', 'svc.p1.c5': 'LEDディスプレイ',
    'svc.p2.tag':      'Enterprise',
    'svc.p2.name':     '企業',
    'svc.p2.desc':     '企業YouTubeチャンネル・社内放送・ビデオ会議システムなど多様な企業メディア環境をサポートします。Zoom・Teams・Webexと完全互換のスマートオフィス環境を実現します。',
    'svc.p2.c1': 'YouTubeスタジオ', 'svc.p2.c2': 'ビデオ会議', 'svc.p2.c3': '社内放送', 'svc.p2.c4': 'Zoom Teams統合', 'svc.p2.c5': 'スマートオフィス',
    'svc.p3.tag':      'Media Center',
    'svc.p3.name':     'メディアセンター',
    'svc.p3.desc':     'P1.5超高精細LEDウォールから大型屋外サイネージ、XRバーチャルスタジオまで、プロのメディアセンターに必要なすべてのソリューションを構築します。',
    'svc.p3.c1': 'LEDウォール', 'svc.p3.c2': 'XRバーチャルスタジオ', 'svc.p3.c3': 'メディアサーバー', 'svc.p3.c4': '大型サイネージ', 'svc.p3.c5': 'メディアアーカイブ',
    'svc.p4.tag':      'Religious Facility',
    'svc.p4.name':     '宗教施設',
    'svc.p4.desc':     '教会・聖堂・寺院など宗教施設に特化した音響・映像・照明統合システムを構築します。礼拝映像配信・LEDサイネージ・オンラインストリーミングまで宗教空間に最適化したソリューションを提供します。',
    'svc.p4.c1': '音響映像統合', 'svc.p4.c2': '礼拝映像配信', 'svc.p4.c3': 'オンライン配信', 'svc.p4.c4': 'LEDサイネージ', 'svc.p4.c5': '照明システム',
